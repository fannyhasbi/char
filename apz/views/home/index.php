...
<head>
  ...
  <link href="<?= base_url(); ?>assets/lib/animate-css/animate.min.css" rel="stylesheet">
  ...
  <section id="hero">
    <div class="hero-container">
      <div class="wow fadeIn">
        ...
        <div class="actions">
          <a href="#about" class="btn-get-started">KETAHUI LEBIH LANJUT</a>
  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <a href="#hero"><img src="<?= base_url(); ?>assets/img/metaflorist.png" alt="" title="" /></img></a>
        ...
        <div class="col-md-3 col-md-push-2">
          <div class="info">
            <div>
              ...
              <p>Jl. Sirojudin<br>Semarang, Jawa Tengah, Indonesia</p>
            </div>
  ...
  <footer id="footer">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="copyright">
            &copy; Copyright <strong>Metaflorist</strong> All Rights Reserved.
          </div>
        </div>
      </div>
    </div>
